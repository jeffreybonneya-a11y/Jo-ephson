    ...
    <>
      <footer className="bg-slate-950 text-slate-400 py-12 border-t border-slate-900">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li><button onClick={() => setPolicyModal('refund')} className="hover:text-primary transition-colors text-left">Refund Policy</button></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-slate-900 text-center text-xs flex flex-col md:flex-row items-center justify-between gap-4">
            <p>&copy; {new Date().getFullYear()} {branding.brandName || 'King J Deals'}. All rights reserved.</p>
            <div className="flex gap-4 text-slate-500">
              <button onClick={() => setPolicyModal('privacy')} className="hover:text-slate-300 transition-colors">Privacy</button>
              <span>•</span>
              <button onClick={() => setPolicyModal('terms')} className="hover:text-slate-300 transition-colors">Terms</button>
              <span>•</span>
              <button onClick={() => setPolicyModal('refund')} className="hover:text-slate-300 transition-colors">Refunds</button>
            </div>
          </div>
        </div>
      </footer>
